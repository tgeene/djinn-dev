      ...
      <form id="passwordGenerationForm" onSubmit={handleSubmit(onSubmit)}>
        ...
        <fieldset>
          ...
          <ul className="character-options">
            {character_list.map((item, i) => (
              <li key={i}>
                <input type="checkbox" name={"character-"+item.name} id={"character-"+item.name} value="1" defaultChecked="checked" />
        ...
        <fieldset>
          ...
          <ul className="feature-options">
            {features_list.map((item, i) => (
              <li key={i}>
                <input type="checkbox" name={"feature-"+item.name} id={"feature-"+item.name} value="1" defaultChecked={item.checked} />
        ...
        <fieldset>
          ...
          <ul className="output-options">
            ...
            <li className="half">
              <label htmlFor="numberOfOutputs">Number of Passwords <span className="required">(required)</span></label>
              <input
                type="number"
