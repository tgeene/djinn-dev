      ...
      <form id="djinnIpsumGenerationForm" onSubmit={handleSubmit(onSubmit)}>
        ...
        <fieldset>
          ...
          <ul className="output-options">
            <li>
              <label htmlFor="numberOfParagraphs">Number of Paragraphs <span className="required">(required)</span></label>
              <input
                type="number"
                ...
                />
              {errors.numberOfParagraphs && <p className="error">{errors.numberOfParagraphs.message}</p>}
            </li>
            <li>
